...
public class ZucheBean {
	public static class Attr {
		...
		public static final String TYPE_START = "zuche_start_date_str";
		public static final String TYPE_END = "zuche_end_date_str";
	...
	public ZucheBean(String id, String car_no, String cunche_start_date_str, String cunche_end_date_str, String status, String username, String money, String days, String image_url) {
		this.id = id;
		this.car_no = car_no;
	...
	public static ArrayList<ZucheBean> newInstanceList(String jsonDatas) {
		ArrayList<ZucheBean> AdvertDatas = new ArrayList<ZucheBean>();
		...
		try {
			...
			for (int i = 0; i < size; i++) {
				...
				ZucheBean bean = new ZucheBean(type_id,car_no,cunche_start_date_str,cunche_end_date_str,status,username,money,days,image_url);
