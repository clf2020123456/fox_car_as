...
public final class Constants {
	...
	public static final String SD_DIR_TMP = "/tmp";
	...
	public static final String APP_BORADCASTRECEIVER="www..net";
	public static final String APP_BORADCASTRECEIVER2="www..net2";
