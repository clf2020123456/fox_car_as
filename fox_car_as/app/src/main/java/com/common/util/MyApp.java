...
//		crashHandler.init(this);
	...
	public String getStatus() {
		String status = sysInitSharedPreferences.getString("status", "");
		return status;
	}

	public void setStatus(String status) {
		this.status = status;
		sysInitSharedPreferences.edit().putString("status", this.status).commit();
	}

	public String getLoginPwd() {
		String loginPwd = sysInitSharedPreferences.getString("loginPwd", "");
		return loginPwd;
	}
	...
	public void setLoginPwd(String loginPwd) {
		...
		sysInitSharedPreferences.edit().putString("loginPwd", this.loginPwd).commit();
	}
